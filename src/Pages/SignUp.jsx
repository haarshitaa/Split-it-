...
//                     <TextField id="email" label="Email" variant="standard" fullWidth value={email} 
//                     onChange={(e) => {
...
//                     <TextField id="username" label="Username" variant="standard" fullWidth value={name}
//                     onChange={(e)=>{
...
//                     <Alert severity="error">Fill all the credentials.</Alert>
//                 }else{
//                     setLoading(true);
//                     try{
